import type { Activity, CatalogActivity, Package, Project, User, WorkPlan } from "@/lib/types";
...
// Planes de trabajo iniciales (estimaciones del supervisor).
export const workPlans: WorkPlan[] = [
  {
    id: 1,
    supervisorId: 55,
    proyectoId: 1,
    descripcion: "Estimación de entregables y sesiones del mes.",
    horasEstimadas: 120,
    fechaInicio: "2024-07-01",
    fechaFin: "2024-07-31",
    archivoNombre: "plan-proyecto-alpha.pdf"
  }
];
